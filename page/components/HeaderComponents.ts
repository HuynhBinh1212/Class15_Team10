...
export class TopBarComponent extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.userProfile = page.locator('header h3, .user-profile, .account-info, a[href*="profile"]').first();
        this.btnLogout = page.locator('header button, header a:has-text("Đăng xuất"), button:has-text("Đăng xuất")').first();
    }
