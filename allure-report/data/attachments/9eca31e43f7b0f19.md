...
Locator: locator('.slick-slider img, .carousel img').first()
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Kiểm tra banner hiển thị locator('.slick-slider img, .carousel img').first() with timeout 10000ms
  - waiting for locator('.slick-slider img, .carousel img').first()
