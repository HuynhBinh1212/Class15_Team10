...
- Name: ui\dashboard\dashboard.spec.ts >> Dashboard Feature >> Movie Search (Quick Booking Bar) >> D_13: Kiểm tra dropdown Rạp hiển thị danh sách rạp khi đã chọn Phim
- Location: tests\ui\dashboard\dashboard.spec.ts:39:9
