...
test.describe("MuiContainer - News Section Feature", () => {
  ...
  test("D_34: Kiểm tra hình ảnh lỗi sau khi click Xem Thêm trong mục Điện ảnh 24h", async ({
    page, tinTucPage
  }) => {
  ...
  test("D_35: Kiểm tra hình ảnh lỗi sau khi click Xem Thêm trong mục Review", async ({
    page, tinTucPage
  }) => {
  ...
  test("D_36: Kiểm tra hình ảnh lỗi sau khi click Xem Thêm trong mục Khuyến Mãi", async ({
    page, tinTucPage
  }) => {
