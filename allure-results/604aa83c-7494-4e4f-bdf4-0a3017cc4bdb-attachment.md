...
- Name: ui\dashboard\dashboard.spec.ts >> Dashboard Feature >> Cinema List >> D_32: Kiểm tra hiển thị nội dung danh sách rạp phim
- Location: tests\ui\dashboard\dashboard.spec.ts:165:9

# Error details

```
Error: Hình ảnh bị lỗi! URL [http://movie0706.cybersoft.edu.vn/hinhanh/bhd-star-cineplex.png] trả về mã trạng thái 404
