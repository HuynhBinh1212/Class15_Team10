...
- Name: ui\dashboard\dashboard.spec.ts >> Dashboard Feature >> Movie Search (Quick Booking Bar) >> D_11: Tìm kiếm bằng chữ cái tên phim trong danh sách phim
- Location: tests\ui\dashboard\dashboard.spec.ts:26:9
