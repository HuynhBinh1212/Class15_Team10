...
- Name: ui\dashboard\dashboard.spec.ts >> Dashboard Feature >> Cinema List >> D_33: Chọn một rạp để xem lịch chiếu
- Location: tests\ui\dashboard\dashboard.spec.ts:178:9
