...
Locator: locator('.movie-card, .film-item, .card').first().locator('img').first()
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('.movie-card, .film-item, .card').first().locator('img').first() with timeout 10000ms
  - waiting for locator('.movie-card, .film-item, .card').first().locator('img').first()
